...
with app.app_context():
    ...
    query_1 = """INSERT INTO "Courses" ("CourseID", "CourseName", "Semester", "Year") VALUES
    (2, 'Software Development', 'Fall', 2024),
    (3, 'Ethics', 'Fall', 2024),
    (4, 'Calculus', 'Fall', 2024);"""
    ...
    SET "CourseName"= 'Database Management', "Semester" = 'Spring'
    WHERE "CourseID" = 3;"""
    db.session.execute(text(query_3))
    db.session.commit()

    # write a query to delete 1 record in the Courses table
    query_4 = """DELETE FROM "Courses" WHERE "CourseID"='1';"""
